      ...
      <div className="dark mx-auto max-w-3xl px-6">
        ...
        <article className="flex flex-col gap-12 md:gap-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="leading-7 text-muted-foreground">
              If you have any questions about this Privacy Policy, please contact us at:<br></br>Email: <a href="mailto:scott@neighborswealthmgmt.com" className="underline">scott@neighborswealthmgmt.com</a><br></br>Phone: <a href="tel:+18632247471" className="underline">+1 (863) 224-7471</a>
            </p>
          </div>
        </article>
      </div>
